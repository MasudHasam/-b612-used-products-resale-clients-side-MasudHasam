...
const Item = ({ data, setOpenModal, openMOdal, reporteItem }) => {
            ...
            <div className="card w-11/12 mx-auto bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className='flex justify-between'>
                        <button onClick={() => reporteItem(data)} className='btn btn-outline btn-sm hover:bg-gray-500'>Report to Admin</button>
                        <label onClick={() => setOpenModal(data)} htmlFor="publicModal" className="btn btn-outline btn-sm">Book Now</label>
                    </div>
                </div>
            </div>
        </div>
